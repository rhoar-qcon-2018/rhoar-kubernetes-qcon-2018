...
<<<
== [[section-5]] Implement REST API

=== [[section-5-a]] Using OpenAPI 3 Spec file to create REST API in Vert.x
...
paths:
  /health:
    get:
      ...
      description: >
        Returns an HTTP response code and a JSON document detailing the current
...
<<<
=== [[section-5-b]] Write Tests For The MainVerticle


<<<
=== [[section-5-c]] Adding The OpenAPI Router Factory To The MainVerticle
