...
.. <<#section-1-a,▼>> Download/Install OpenShift Client Tools
.. <<#section-1-b,▼>> Clone The Repositories
.. <<#section-1-c,▼>> Log In To OpenShift
.. <<#section-1-d,▼>> Deploy Using Ansible
.. <<#section-1-e,▼>> Final Configurations
...
<<<
=== [[section-1]] Load A Complete DevOps Environment In Kubernetes
...
==== [[section-1-c]] Log In To The OpenShift Cluster
...
==== [[section-1-d]] Deploy The DevOps environment using Ansible
