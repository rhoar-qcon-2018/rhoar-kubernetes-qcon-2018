...
==== Metrics (Prometheus/Hawkular/Heapster)
OpenShift can be deployed along with Prometheus and Hawkular metrics tracking. When deployed these services provide
...
=== Deploy The DevOps environment using Ansible
...
. Open your DevOps Environment labeled as `USERNAME-labs-ci-cd`
...
[#image-github-insult-webhook-url]
[caption="Figure 17: "]
...
.src/test/groovy/com/redhat/qcon/services/insult/InsultServiceImplSpec.java
[source,java,subs=attributes+]
----
...
.src/main/java/com/redhat/qcon/insult/services/insult/InsultService.java
[source,java,subs=attributes+]
----
    /**
...
Earlier we created a *_Jenkinsfile_* for our service so that we can automatically build our code and test it as
we write and commit it to our source repositories.
