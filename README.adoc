...
This code is simple to test and easier to read. As we go forward, this is the pattern I will advocate. Now, let's
implement some methods so that we can make requests to our associated microservices and retrieve the results.
